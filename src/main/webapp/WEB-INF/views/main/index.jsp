    ...
    <main>
        ...
        <div class="content_area">
            <div class="goods_info">
                ...
                <p><i class="fas fa-clock"></i> 업데이트 날짜 : <span><fmt:formatDate value="${update.goods_date}" pattern="yyyy-MM-dd HH:mm:ss"/></span></p>
            </div>
            <div class="customer_info">
                ...
                <p><i class="fas fa-clock"></i> 업데이트 날짜 : <span>2021-12-10 12:00:00</span></p>
            </div>
